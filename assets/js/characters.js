...
// Create data
    var data = [
      ...
      {x: ["Evelyn", "Joy"], value: 3, name: "EVELYN & JOY", desc: "They are both daughters that just want to be fully accepted by their parents.", img: "https://media.giphy.com/media/dIf76fQGLFrtqMxYDC/giphy.gif",
